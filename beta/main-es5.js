...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PhotoComponent = /** @class */ (function () {
                ...
                PhotoComponent.prototype.onClick = function (button) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PhotographyComponent = /** @class */ (function () {
                ...
                PhotographyComponent.prototype.createSkeletonElements = function () {
                    ...
                    try {
                        for (var _b = __values(this.photosOrder), _c = _b.next(); !_c.done; _c = _b.next()) {
                            ...
                            var photoElement = {
                                src: this.photosMetadata[photoId].sizes.find(function (size) { return size.label == "Medium 640"; }).source,
                                srcOriginal: this.photosMetadata[photoId].sizes.find(function (size) { return size.label == "Original"; }).source,
                            };
                ...
                PhotographyComponent.prototype.openFullscreen = function (event) {
                    console.log(event);
                };
